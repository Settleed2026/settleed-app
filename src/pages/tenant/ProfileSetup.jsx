...
<<<<<<< HEAD
              <input
                ...
                value={data.currentStreetAddress}
                onChange={e => set('currentStreetAddress', e.target.value)}
...
<<<<<<< HEAD
            ...
            {data.requiresAccessibleUnit && (
              <div>
                <label className={labelClass}>Accessibility needs (select all that apply)</label>
                <div className="grid grid-cols-2 gap-2">
...
<<<<<<< HEAD
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <select className={inputClass} value={data.lengthOfStay}
                ...
                <div>
                  ...
                  <input className={inputClass} placeholder="e.g. Looking for a larger unit"
                    value={data.reasonForMoving} onChange={e => set('reasonForMoving', e.target.value)} />
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <div className="space-y-2">
                <Toggle label="I own a vehicle" checked={data.ownsVehicle}
                  onChange={() => set('ownsVehicle', !data.ownsVehicle)} />
                {data.ownsVehicle && (
                  <div>
